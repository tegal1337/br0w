...
<body class="imgloaded">
    ...
    <div class="jumbotron bg-transparent mb-0 pt-3 radius-0">
        <div class="container">
            <div class="row">
                <div class="col-xl-10">
                    <h1 class="display-1 bold color_white content__title">TEGAL1337 BR0W<span class="vim-caret">&nbsp;</span></h1>
                    ...
                    <div class="row  hackerFont">
                        <div class="col-md-6">
                            <div class="form-group">
                                <input type="text" class="form-control" id="team_name" placeholder="github name">
                            </div>
                            <div class="form-group">
                                <input type="email" class="form-control" id="email" placeholder="email">
                                <small id="passHelp" class="form-text text-muted">Make sure the email you write is correct</small>
                            </div>
            ...
            <div class="row">
                <div class="col-xl-12">
                    <button class="btn btn-outline-danger btn-shadow px-3 my-2 ml-0 ml-sm-1 text-left typewriter" onclick="window.location.href='login.php';">
                            <h4>Register</h4>
                    </button>
                </div>
            </div>
