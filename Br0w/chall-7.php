...
<body class="imgloaded">
  ...
  <div class="siimple-grid-row">
    <div>
        <div>
          <h3 class="bold color_danger">Disable Inline CSS</h3>
          <h4 class="bold color_white">Console</h4>
          <div class="siimple-box-detail" id="content"></div>
        </div>
        <div id="stylecss" style="display:none;"></div>
...
<script>
document.getElementById("stylecss").innerHTML = random;
verify();
function verify(){
    if(document.getElementById("guess").value === random.toString()){
         document.getElementById("content").innerHTML = "Flag : <span class=\"siimple-tag siimple-tag--red\">" + document.getElementById("guess").value.toString() + "</span><br><br><div class=\"btn btn-outline-danger btn-shadow px-3 my-2 ml-0 ml-sm-1 text-left typewriter\"><a href=\"chall-8.php\">Next</a></div>";
     }else{
