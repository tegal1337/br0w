                    ...
                    <div class="row justify-content-center  hackerFont ">
                        <div class="col-md-10">
                            ...
                            <ul>
                                ...
                                <li>I made every challenge in such a way to make it easier to understand</li>
                            ...
                            <div class="row text-center pt-5">
                                <div class="col-xl-12">
                                    <button class="btn btn-outline-danger btn-shadow px-3 my-2 ml-0 ml-sm-1 text-left typewriter" onclick="(function(){window.location.href='index.php'})();">
                                        <h4>LET THE HACKING BEGIN!</h4>
                                    </button>
                                    <small id="registerHelp" class="mt-2 form-text text-muted">We expect each and every one of you to comply by the rules. Thanks !</small>
                                </div>
                            </div>
                        </div>
                    </div>
