...
<body class="imgloaded">
  ...
  <div class="siimple-grid-row">
    <div>
        <div>
          <h3 class="bold color_danger">Response Header</h3>
          <h4 class="bold color_white">Enter the four digit header value</h4>
...
<script>
function verify(){
	if(document.getElementById("guess").value === "3137"){
		 document.getElementById("content").innerHTML = "Current header value you entered is: <span class=\"siimple-tag siimple-tag--red\">" + document.getElementById("guess").value.toString() + "</span><br><br><div class=\"btn btn-outline-danger btn-shadow px-3 my-2 ml-0 ml-sm-1 text-left typewriter\"><a href=\"step-0a.php\">Next</a></div>";
	 }else{
		 document.getElementById("content").innerHTML = "Current header value you entered is: <span class=\"siimple-tag siimple-tag--orange\">" + document.getElementById("guess").value.toString() + '</span><br><br><a href="https://getmantra.com/web-app-security-testing-with-browsers/index.php#viewheaders" target="_blank"><div class="siimple-btn siimple-btn--navy">Learn how to do it.</div></a>'; 
	 }
}
