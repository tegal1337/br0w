...
<head>
    ...
    <script>
    if (localStorage.getItem("thebr0w") === null) {
     localStorage.setItem("thebr0w", "thebr0w");
    }
    </script>
</head>
...
<body class="imgloaded">
  ...
  <div class="siimple-grid-row">
    <div>
        <div>
          <h3 class="bold color_danger">LocalStorage</h3>
          <h4 class="bold color_white">Change <b>thebr0w</b> LocalStorage value to <b>tegal1337</b></h4>
...
<script>
if (localStorage.getItem("thebr0w") !== null) {
     if (localStorage.getItem("thebr0w") === "tegal1337") {
         document.getElementById("content").innerHTML = "Current value of <b>thebr0w</b> LocalStorage is: <span class=\"siimple-tag siimple-tag--green\">" + localStorage.getItem("thebr0w").toString() + "</span><br><br><div class=\"btn btn-outline-danger btn-shadow px-3 my-2 ml-0 ml-sm-1 text-left typewriter\"><a href=\"chall-5.php\">Next</a></div>";
     }else{
         document.getElementById("content").innerHTML = "Current value of <b>thebr0w</b> LocalStorage is: <span class=\"siimple-tag siimple-tag--orange\">" + localStorage.getItem("thebr0w").toString() + '</span>'; 
     }
}
