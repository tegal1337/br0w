...
<body class="imgloaded">
  ...
  <div class="siimple-grid-row">
    <div>
        <div>
          <h3 class="bold color_danger">Disable Javascript</h3>
          <h4 class="bold color_white">Enter Special Character</h4>
          <div class="siimple-box-detail" id="content"></div>
        </div>
        <form type="submit" action="finish.php" method="post">
              Input: <input type="text" name="input" value="0" onkeypress="return blockSpecialChar(event)">
              <input type="submit" class="btn btn-outline-danger btn-shadow px-3 my-2 ml-0 ml-sm-1 text-left typewriter" value="Submit">
            </form>
    </div>
  </div>
</div>
