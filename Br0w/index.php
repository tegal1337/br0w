            ...
            <div class="container">
                <div class="row">
                    <div class="col-xl-8">
                        ...
                        <h1 class="display-1 bold color_white content__title2">TEGAL1337</h1>
                    </div>
                </div>
                <div class="row">
                    <div class="col-xl-4">
                        <p class="mt-5 text-grey text-spacey hackerFont lead">
                            Play your browser and learn more, hack fun !!
                        </p>
                        <button class="btn btn-outline-danger btn-shadow px-3 my-2 ml-0 ml-sm-1 text-left typewriter" onclick="(function(){window.location.href='chall-1.php'})();">
                            <h4>Start</h4>
                        </button>
                    </div>
                </div>
