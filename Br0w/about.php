                ...
                <div class="collapse navbar-collapse" id="navbarNavAltMarkup">
                    ...
                    <div class="navbar-nav ml-auto">
                        <a href="index.php" class="p-3 text-decoration-none text-white bold">Home</a>
                            ...
                            <a href="instructions.php" class="p-3 text-decoration-none text-light bold">Rules</a>
                ...
                <div class="col-xl-12">
                    ...
                    <div class="row justify-content-center hackerFont">
                        <div class="col-md-8">
                            ...
                            Tegal1337 is a non-profit organization. This community is not a hacker group, but a forum for IT activists, especially those who live in Tegal and its surroundings. the beginning of the formation of Tegal1337 was just a blog about information technology
                            <h5 class="bold color_white pt-3">
                                Join us
                            </h5>
                            We are open to anyone who wants to contribute and want to learn more. contact root@tegalsec.org
                            <div class="row text-center pt-5">
                                <div class="col-xl-12">
                                    <button class="btn btn-outline-danger btn-shadow px-3my-2 ml-0 ml-sm-1 text-left typewriter" onclick="(function(){window.location.href='index.php'})();">
                                        <h4>LET IT RIP!</h4>
                                        </button>
                                </div>
                            </div>
