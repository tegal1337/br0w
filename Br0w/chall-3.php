        ...
        <div class="container">
            <div class="row">
                <div class="col-xl-8">
                    ...
                    <h3 class="bold color_danger">Edit cookie</h3>
		  			<h4 class="bold color_white">Change <b>hackthebrowser</b> cookie value to <b>tegal1337</b></h4>
		            <div class="siimple-box-detail"> 
<?php
if (isset($_COOKIE['hackthebrowser'])) {
	if ($_COOKIE['hackthebrowser'] === "tegal1337") {
    echo "Your current name supplied by <b>hackthebrowser</b> cookie is: <span class=\"siimple-tag siimple-tag--red\">" . (string)$_COOKIE['hackthebrowser'] . '</span>';
    echo '<br><br><div class="btn btn-outline-danger btn-shadow px-3 my-2 ml-0 ml-sm-1 text-left typewriter"><a href="chall-4.php">Next</a></div>';
} else
{

    echo "Current value supplied by <b>hackthebrowser</b> cookie is: <span class=\"siimple-tag siimple-tag--navy\">" . (string)$_COOKIE['hackthebrowser'] . '</span>'; 
}
}
