        ...
        <div class="container">
            <div class="row">
                <div class="col-xl-8">
                    ...
                    <h3 class="bold color_danger">User Agent</h3>
                    <h4 class="bold color_white">Change your user agent to <b>tegal1337</b></h4>
                <div class="siimple-box-detail">You current user agent is:

              <?php
if ($_SERVER['HTTP_USER_AGENT'] === "tegal1337"){
echo '<span class="siimple-tag siimple-tag--red">' . (string)$_SERVER['HTTP_USER_AGENT'] . '</span>';
echo '<br><br><button class="btn btn-outline-danger btn-shadow px-3 my-2 ml-0 ml-sm-1 text-left typewriter"><h4><a href="chall-2.php">Next Chall</a></h4></button>';
}else {
echo '<span class="siimple-tag siimple-tag--red">' . (string)$_SERVER['HTTP_USER_AGENT'] . '</span>';
}
?>
