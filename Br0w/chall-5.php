...
<body class="imgloaded">
  ...
  <div class="siimple-grid-row">
    <div>
        <div>
          <h3 class="bold color_danger">Disable Eksternal CSS</h3>
...
function verify(){
    if(document.getElementById("guess").value === random.toString()){
         document.getElementById("content").innerHTML = "Flag : <span class=\"siimple-tag siimple-tag--red\">" + document.getElementById("guess").value.toString() + "</span><br><br><div class=\"btn btn-outline-danger btn-shadow px-3 my-2 ml-0 ml-sm-1 text-left typewriter\"><a href=\"chall-6.php\">Next</a></div>";
     }else{
